...
`;
    ...
    try {
        ...
        await assert.rejects(service.buildMissingImports({ ...missing, buildTargets: [...missing.buildTargets] }), /刚刚产生且尚未使用/);
        ...
        await assert.rejects(service.buildMissingImports(mutated), /与检查时列出的精确模块不一致/);
    }
    finally {
        service.stop();
    }
});
//# sourceMappingURL=lean-repl.test.js.map